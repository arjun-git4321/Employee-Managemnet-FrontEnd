    ...
    return(
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 ">
                <SummaryCard icon={<FaUsers/>} text="Total Employes" number={13} color='bg-teal-600'/>
                <SummaryCard icon={<FaBuilding/>} text="Total Departments" number={5} color='bg-yellow-600'/>
                <SummaryCard icon={<FaMoneyBillWave/>} text="Monthly Income" number="$654" color='bg-red-600'/>
            ...
            <div className="mt-12">
                ...
                <SummaryCard icon={<FaCheckCircle/>} text="Total Approved" number={2} color='bg-yellow-600'/>
                <SummaryCard icon={<FaHourglassHalf/>} text="Leave Pending" number={2} color='bg-green-600'/>
